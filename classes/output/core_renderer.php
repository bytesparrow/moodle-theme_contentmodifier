...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function main_content() {
        ...
        if (!$contextid || !$courseid) {
            // Abbruch - wir sind in nem iframe, schauen gerade keinen content an, content ohne kurs etc.
            return $maincontent;
        }
        // Initialize rendererfactory.
        $modifierfactory = new \theme_extended_overridden_renderer_factory($this->page->theme);
        $pagemodifiers = $modifierfactory->get_modifiers($this->page);
        // Erste Idee war das,  aber rendererfactory ist private.
        // $pagemodifiers = $PAGE->theme->rendererfactory->get_modifiers(); .
